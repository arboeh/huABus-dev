...
- **Experimenteller Batch-Modus (v1.10.0+):** Optionaler Modus für 75% schnellere Modbus-Zyklen mit automatischem Fallback
...
- ✅ **v1.10.0:** Experimenteller Batch-Modus für bis zu 75% schnellere Modbus-Zyklen (Opt-in Beta)
