...
async def main_once(bridge):
    ...
    try:
        ...
        logging.warning("DecodeError during bridge.update(): %s - skipping this cycle", e)
        raise
...
async def main():
    ...
    # WICHTIG: Signatur von HuaweiSolarBridge.create für deine Version
    # Aktuell laut Fehlermeldung: create(host, port, slave_id, update_lock)
    update_lock = asyncio.Lock()
